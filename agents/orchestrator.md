...
3. **No prior-round shrink or disappearance.** Every `reviews/04-adversary-r{1..N-1}.md` still exists and its size has not decreased since the value recorded at its own round's Phase Transition Protocol write.
