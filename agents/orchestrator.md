...
- coderabbit_configured: {true|false}          # set at Phase 0a Step 7 from a repo-root file check; consumed by delivery Step 11.4 (rollup signal can upgrade false→detected)
