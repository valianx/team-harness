...
- A `## Closure Rubric` heading, or any of its three constituent tables (ownership closure, provenance, removed-control), inside `01-plan.md`. The rubric is a review-panel artifact and its sole destination is `reviews/01-plan-review.md § Closure Rubric` — see `### Closure rubric` below.
