...
|---|---|---|---|---|
| `orchestrator` | opus | `high` | Read, Edit, Write, Bash, Glob, Grep, Task, WebFetch, WebSearch, NotebookEdit, all 6 `mcp__memory__*` (KG read + write, no destructive ops) | Central hub. Coordinates the pipeline and routes to all other agents. |
