...
effort: max
color: orange
tools: Read, Glob, Grep, Edit, Write, WebFetch, WebSearch, mcp__context-harness__search_nodes, mcp__context-harness__open_nodes, mcp__memory__search_nodes, mcp__memory__open_nodes
---
