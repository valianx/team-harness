...
**Reason**: The one-time backfill ran in #614 and `openspec/specs/` exists; a completed chore is not an ongoing requirement.

**Migration**: None. The archive directory and `openspec/specs/` already hold the result.
