...
- [x] 1.1 Update spec and shared validation guidance to resume existing work and reuse test execution and assessments across tools.
- [x] 1.2 Simplify inline review preparation, contextual reading, native readiness and recovery across Claude, Codex and OpenCode guidance.
