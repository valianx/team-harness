...
Retirement (2026-09-19): `workflow-only-cleanup` removes the TH policy guard and its distribution. This guard-specific capability is wholly superseded and closes without applying its delta to living specs. The completed tasks preserve the historical fix evidence.
