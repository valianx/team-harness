...
- The original Windows permission-hook delta is retired: the native-workflow
  changes removed those hooks and their launchers. Archive must not restore them.
