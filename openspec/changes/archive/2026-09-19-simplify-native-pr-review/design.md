...
Completion scope (2026-09-19): the operator grouped the remaining runtime cleanup and review parity into one PR. The functional requirements below remain unchanged. Focused fixture/regression evidence closes this delivery; the comparative token/latency pilot remains a separate #662 experiment. The original pilot design below is retained as a research reference, not claimed as executed or used as a publication prerequisite.
