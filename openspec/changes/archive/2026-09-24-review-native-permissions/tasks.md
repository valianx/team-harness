## 1. Native permission inheritance

- [x] 1.1 Remove TH owner-only permissions from review directory creation and regenerate runtime copies.
- [x] 1.2 Document scoped recovery for existing restricted directories without an automatic ACL rewrite.
