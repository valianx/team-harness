...
- [x] 3.1 Add or update focused contract tests for intent-routed direct modes, short affirmative/negative replies, natural-language amendments, concise ambiguity handling, untrusted-content rejection, explicit-only pipeline activation, and unchanged authority identities without creating an exhaustive phrase or Markdown-wording contract.
