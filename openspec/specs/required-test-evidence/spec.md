# required-test-evidence Specification

## Purpose
Report selected test execution and omissions proportionally, so passing commands do not imply unperformed verification.
