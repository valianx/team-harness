...
This is the opencode projection of the canonical Team Harness `issue`
...
1. Treat the live operator request for `issue` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:issue` name the same capability; interpret them as examples rather than requiring Claude Code.
