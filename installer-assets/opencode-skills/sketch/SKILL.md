...
This is the opencode projection of the canonical Team Harness `sketch`
...
1. Treat the live operator request for `sketch` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:sketch` name the same capability; interpret them as examples rather than requiring Claude Code.
