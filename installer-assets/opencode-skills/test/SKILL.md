...
This is the opencode projection of the canonical Team Harness `test`
...
1. Treat the live operator request for `test` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:test` name the same capability; interpret them as examples rather than requiring Claude Code.
