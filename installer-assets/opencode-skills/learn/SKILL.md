...
This is the opencode projection of the canonical Team Harness `learn`
...
1. Treat the live operator request for `learn` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:learn` name the same capability; interpret them as examples rather than requiring Claude Code.
