---
name: implement
description: "Implement an authorized change and verify the affected behavior."
---
...
This is the opencode projection of the canonical Team Harness `implement`
...
1. Treat the live operator request for `implement` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:implement` name the same capability; interpret them as examples rather than requiring Claude Code.
