...
This is the opencode projection of the canonical Team Harness `excalidraw-diagram`
...
1. Treat the live operator request for `excalidraw-diagram` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:excalidraw-diagram` name the same capability; interpret them as examples rather than requiring Claude Code.
