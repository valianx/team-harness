...
This is the opencode projection of the canonical Team Harness `create-pr`
...
1. Treat the live operator request for `create-pr` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:create-pr` name the same capability; interpret them as examples rather than requiring Claude Code.
