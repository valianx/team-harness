...
This is the opencode projection of the canonical Team Harness `modes`
...
1. Treat the live operator request for `modes` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:modes` name the same capability; interpret them as examples rather than requiring Claude Code.
