...
This is the opencode projection of the canonical Team Harness `workspace`
...
1. Treat the live operator request for `workspace` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:workspace` name the same capability; interpret them as examples rather than requiring Claude Code.
