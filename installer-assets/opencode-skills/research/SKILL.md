...
This is the opencode projection of the canonical Team Harness `research`
...
1. Treat the live operator request for `research` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:research` name the same capability; interpret them as examples rather than requiring Claude Code.
