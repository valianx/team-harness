---
name: plan-review
description: "Critique a proposed plan or OpenSpec change with independent judgment."
---
...
This is the opencode projection of the canonical Team Harness `plan-review`
...
1. Treat the live operator request for `plan-review` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:plan-review` name the same capability; interpret them as examples rather than requiring Claude Code.
