...
This is the opencode projection of the canonical Team Harness `obsidian-cli`
...
1. Treat the live operator request for `obsidian-cli` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:obsidian-cli` name the same capability; interpret them as examples rather than requiring Claude Code.
