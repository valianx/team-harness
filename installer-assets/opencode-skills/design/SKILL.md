...
This is the opencode projection of the canonical Team Harness `design`
...
1. Treat the live operator request for `design` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:design` name the same capability; interpret them as examples rather than requiring Claude Code.
