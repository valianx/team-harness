...
This is the opencode projection of the canonical Team Harness `json-canvas`
...
1. Treat the live operator request for `json-canvas` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:json-canvas` name the same capability; interpret them as examples rather than requiring Claude Code.
