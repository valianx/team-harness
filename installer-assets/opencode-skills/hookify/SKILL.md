...
This is the opencode projection of the canonical Team Harness `hookify`
...
1. Treat the live operator request for `hookify` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:hookify` name the same capability; interpret them as examples rather than requiring Claude Code.
