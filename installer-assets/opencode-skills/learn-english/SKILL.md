...
This is the opencode projection of the canonical Team Harness `learn-english`
...
1. Treat the live operator request for `learn-english` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:learn-english` name the same capability; interpret them as examples rather than requiring Claude Code.
...
6. Read and update only the opencode-native Team Harness configuration.
