...
This is the opencode projection of the canonical Team Harness `d2-diagram`
...
1. Treat the live operator request for `d2-diagram` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:d2-diagram` name the same capability; interpret them as examples rather than requiring Claude Code.
