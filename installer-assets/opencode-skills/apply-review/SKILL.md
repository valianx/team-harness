...
This is the opencode projection of the canonical Team Harness `apply-review`
...
1. Treat the live operator request for `apply-review` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:apply-review` name the same capability; interpret them as examples rather than requiring Claude Code.
