...
This is the opencode projection of the canonical Team Harness `audit`
...
1. Treat the live operator request for `audit` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:audit` name the same capability; interpret them as examples rather than requiring Claude Code.
