...
This is the opencode projection of the canonical Team Harness `security`
...
1. Treat the live operator request for `security` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:security` name the same capability; interpret them as examples rather than requiring Claude Code.
