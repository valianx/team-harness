...
This is the opencode projection of the canonical Team Harness `audit-security`
...
1. Treat the live operator request for `audit-security` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:audit-security` name the same capability; interpret them as examples rather than requiring Claude Code.
