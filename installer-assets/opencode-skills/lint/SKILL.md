...
This is the opencode projection of the canonical Team Harness `lint`
...
1. Treat the live operator request for `lint` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:lint` name the same capability; interpret them as examples rather than requiring Claude Code.
...
6. Audit opencode-projected agents, skills, commands, and native configuration; do not inspect a Claude Code installation.
