...
This is the opencode projection of the canonical Team Harness `spike`
...
1. Treat the live operator request for `spike` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:spike` name the same capability; interpret them as examples rather than requiring Claude Code.
