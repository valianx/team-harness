...
This is the opencode projection of the canonical Team Harness `define-ac`
...
1. Treat the live operator request for `define-ac` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:define-ac` name the same capability; interpret them as examples rather than requiring Claude Code.
