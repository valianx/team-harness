...
This is the opencode projection of the canonical Team Harness `research-code`
...
1. Treat the live operator request for `research-code` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:research-code` name the same capability; interpret them as examples rather than requiring Claude Code.
