...
This is the opencode projection of the canonical Team Harness `interactive-presentation`
...
1. Treat the live operator request for `interactive-presentation` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:interactive-presentation` name the same capability; interpret them as examples rather than requiring Claude Code.
