...
This is the opencode projection of the canonical Team Harness `spec`
...
1. Treat the live operator request for `spec` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:spec` name the same capability; interpret them as examples rather than requiring Claude Code.
