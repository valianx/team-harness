...
| `pr-review-qa` | `sonnet` | `high` | `gpt-5.6-luna` | `max` | not shipped in Codex beta |
| `pr-review-security` | `sonnet` | `high` | `gpt-5.6-luna` | `max` | not shipped in Codex beta |
| `qa-plan` | `sonnet` | `high` | `gpt-5.6-luna` | `max` | not shipped in Codex beta |
| `qa` | `sonnet` | `high` | `gpt-5.6-luna` | `max` | installed custom agent |
...
| `reviewer-consolidator` | `sonnet` | `medium` | `gpt-5.6-luna` | `max` | not shipped in Codex beta |
| `reviewer` | `sonnet` | `high` | `gpt-5.6-luna` | `max` | not shipped in Codex beta |
