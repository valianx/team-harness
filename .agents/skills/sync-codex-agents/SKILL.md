...
3. Present the exact generated changes:
   ...
   ```bash
   git status --short -- .codex/config.toml .codex/agents .codex/README.md plugins/team-harness/skills/setup/assets/agents
   git diff -- .codex/config.toml .codex/agents .codex/README.md plugins/team-harness/skills/setup/assets/agents
   ```
...
- Treat `.codex/config.toml`, `.codex/agents/*.toml`, `.codex/README.md`, and
  `plugins/team-harness/skills/setup/assets/agents/*.toml` as generator-owned
  outputs.
