...
This is the Codex projection of the canonical Team Harness `interactive-presentation`
...
1. Treat the live operator request for `$team-harness:interactive-presentation` as the canonical
   `$ARGUMENTS` value. Examples use `$team-harness:interactive-presentation` as the supported Codex skill invocation; do not try to execute it as a shell command.
