...
This is the Codex projection of the canonical Team Harness `hookify`
...
1. Treat the live operator request for `$team-harness:hookify` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:hookify` name the same capability; do not try to execute them as shell commands.
