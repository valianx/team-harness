...
This is the Codex projection of the canonical Team Harness `gcp-infra`
...
1. Treat the live operator request for `$team-harness:gcp-infra` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:gcp-infra` name the same capability; do not try to execute them as shell commands.
