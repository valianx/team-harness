...
This is the Codex projection of the canonical Team Harness `sketch`
...
1. Treat the live operator request for `$team-harness:sketch` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:sketch` name the same capability; do not try to execute them as shell commands.
