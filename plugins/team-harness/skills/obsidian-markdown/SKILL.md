...
This is the Codex projection of the canonical Team Harness `obsidian-markdown`
...
1. Treat the live operator request for `$team-harness:obsidian-markdown` as the canonical
   `$ARGUMENTS` value. Examples use `$team-harness:obsidian-markdown` as the supported Codex skill invocation; do not try to execute it as a shell command.
