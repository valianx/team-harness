...
This is the Codex projection of the canonical Team Harness `security`
...
1. Treat the live operator request for `$team-harness:security` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:security` name the same capability; do not try to execute them as shell commands.
