...
This is the Codex projection of the canonical Team Harness `workspace`
...
1. Treat the live operator request for `$team-harness:workspace` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:workspace` name the same capability; do not try to execute them as shell commands.
