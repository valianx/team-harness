...
This is the Codex projection of the canonical Team Harness `design`
...
1. Treat the live operator request for `$team-harness:design` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:design` name the same capability; do not try to execute them as shell commands.
