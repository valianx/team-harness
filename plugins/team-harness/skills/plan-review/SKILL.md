...
This is the Codex projection of the canonical Team Harness `plan-review`
...
1. Treat the live operator request for `$team-harness:plan-review` as the canonical
   `$ARGUMENTS` value. Examples use `$team-harness:plan-review` as the supported Codex skill invocation; do not try to execute it as a shell command.
