...
This is the Codex projection of the canonical Team Harness `create-pr`
...
1. Treat the live operator request for `$team-harness:create-pr` as the canonical
   `$ARGUMENTS` value. Examples use `$team-harness:create-pr` as the supported Codex skill invocation; do not try to execute it as a shell command.
