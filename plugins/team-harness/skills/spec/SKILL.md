...
This is the Codex projection of the canonical Team Harness `spec`
...
1. Treat the live operator request for `$team-harness:spec` as the canonical
   `$ARGUMENTS` value. Examples written as `/th:spec` name the same capability; do not try to execute them as shell commands.
