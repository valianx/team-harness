...
This is the Codex projection of the canonical Team Harness `lint`
...
1. Treat the live operator request for `$team-harness:lint` as the canonical
   `$ARGUMENTS` value. Examples use `$team-harness:lint` as the supported Codex skill invocation; do not try to execute it as a shell command.
...
6. Audit Codex plugin skills, generated agents, and native configuration paths; do not inspect or repair a Claude Code installation.
