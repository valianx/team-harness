---
name: pipeline
description: Coordinate Spec, Implementation, Validation and Publication in Codex.
---
...
QA, security and delivery. Read their installed contracts when dispatching.
