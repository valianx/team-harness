...
`required_lenses`, advisory `risk_signals`, and the selected `lens`. Inspect the project
...
- `adversary`: when Main explicitly selects this
  ...
  certification. Risk signals may inform Main's selection but never add this
  lens automatically.
