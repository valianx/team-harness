...
- `_shared/dispatch-contract.md` — single source of truth for dispatch prompt content, the pipeline specialist reference handshake, and the two-halves scope rule. Coordinators and leaf specialists consume it by pointer; never restate it inline.
