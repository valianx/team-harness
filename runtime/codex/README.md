...
Harness roster, with an explicit availability column distinguishing the eleven
...
agent's model/effort, one of the eleven installed role contracts, its Codex
