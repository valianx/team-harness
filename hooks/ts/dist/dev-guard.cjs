...
function rejectUnparsableOrRedirected(cmdStr) {
...
function evaluateDestinationBranch(dst, reader, allowContext) {
...
function evaluateBarePush(reader) {
...
function evaluateSingleRefspec(refspec, reader) {
