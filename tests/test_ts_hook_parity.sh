...
assert_parity "curl -X POST api.github.com/reviews (ASK)" "$(make_bash_payload 'curl -X POST https://api.github.com/repos/owner/repo/pulls/42/reviews -d "{}"')" "ask"
...
assert_parity "#298 AC-2 curl api.github.com POST (ASK)" "$(make_bash_payload 'curl -X POST https://api.github.com/repos/o/r/pulls/1/reviews -d "{}"')" "ask"
