...
check(
    "suite68(ac11f): CLAUDE.md §3 current-version reads 2.60.1",
    "2.60.1" in _s68_claude,
    "CLAUDE.md §3 current-version line must read 2.60.1 (patch bump from 2.60.0)",
)
...
check(
    "suite68(ac12a): .claude-plugin/plugin.json version is 2.60.1",
    '"2.60.1"' in _s68_plugin,
    ".claude-plugin/plugin.json version field must be 2.60.1 (patch bump from 2.60.0)",
)
check(
    "suite68(ac12b): .claude-plugin/marketplace.json plugins[0].version is 2.60.1",
    '"2.60.1"' in _s68_marketplace,
    ".claude-plugin/marketplace.json plugins[0].version must be 2.60.1 (patch bump from 2.60.0)",
)
