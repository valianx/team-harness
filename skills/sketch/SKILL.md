---
name: sketch
description: Create or revise a lightweight sketch when the user wants to inspect a proposed solution before implementation. Use on demand in direct work, OpenSpec or an active pipeline.
---
