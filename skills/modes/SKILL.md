---
name: modes
description: List Team Harness skills and direct modes alphabetically with concise purposes and runtime-aware invocation guidance. Use when the operator asks for Team Harness help, commands, modes, capabilities, or which workflow to invoke. This read-only catalog never activates another skill or pipeline.
---
