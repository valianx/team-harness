...
reproduction receipts and their required captured objects when present. Only then remove the
worktree and genuinely nonessential artifacts after every reviewer has joined. `cancel`
explicitly removes all artifacts at the same
