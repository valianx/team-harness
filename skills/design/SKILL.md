...
and relevant project context. For a solution proposal, read the
...
already-authorized implementation continues. In an active pipeline, read its
matching phase reference under `../pipeline/references/` as needed. Main retains
coordination; do not dispatch a nested orchestrator.
