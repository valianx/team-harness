---
name: workspace
description: Select, reuse and maintain the shared local or Obsidian workspace for a task. Use across TH workflows and substantive direct work that benefits from retained context, artifacts or a handoff.
---
