...
| `overview.md` (initiative) | operator-facing | `agents/ref-dispatch-machinery.md § overview.md Template` (unchanged) | leader (sole writer; `delivery` only RETURNS per-project completion-row data, the leader reconciles and writes it) |
