...
| `test_github_identity_routes.py` | Cross-runtime GitHub route validation, longest-prefix resolution, isolated/account-switch strategies, atomic preservation, secret rejection, and generated-helper byte identity |
