...
| AC-4 | Suite 82 (`tests/test_agent_structure.py`) flipped to `.html` + grep-safe negative assertions | `tests/test_agent_structure.py:18677-18690,18700,18777-18810` PASS (3428/3428) | same anchors PASS | n/a |
...
| AC-6 | Closing grep: 0 residual `ui-wireframe.md` hits; consumers generalize glob to `sketches/*` | grep `ui-wireframe\.md` across agents/ skills/ hooks/ docs/ tests/ → 0 hits | `reviews/04-validation.md` AC-6 row PASS (10 consumers confirmed) | n/a |
