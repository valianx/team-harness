...
| Frontend-scope tasks (`frontend_scope: true`) | Standard pipeline + `ux-reviewer` (enrich after architect in Stage 1, validate in parallel in Stage 3) | `01-ux-review.md` + `04-ux-validation.md` |
